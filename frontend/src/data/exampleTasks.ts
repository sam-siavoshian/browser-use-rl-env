...
export const EXAMPLE_TASKS: ExampleTask[] = [
  {
    id: 'amazon-search',
    label: 'Learn how to compare products on Amazon',
    task:
  ...
  {
    id: 'wiki-compare',
    label: 'Learn how to research a topic on Wikipedia',
    task:
  ...
  {
    id: 'hn-story',
    label: 'Learn how to read a Hacker News thread end-to-end',
    task:
  ...
  {
    id: 'github-repo',
    label: 'Learn how to inspect a repo on GitHub',
    task:
  ...
  {
    id: 'recipe-details',
    label: 'Learn how to pull recipe details from a cooking site',
    task:
