 ...
 *   RACE flow: Task → 3-layer match → Rocket (Playwright/CDP) → Agent Handoff → Result
...
/* ═══════════════════════════════════════════
   ...
   Task → Template Search (3-layer) → Match?
     YES → Rocket (Playwright/CDP) → Agent Handoff → Result
    ...
    <div className="flex justify-center overflow-x-auto pb-2">
      <div className="relative shrink-0" style={{ width: W, height: H }}>
        ...
        <N left={80} top={204} w={180} h={92} border="rgba(200,255,0,0.18)">
          <span className="text-[10px] font-mono text-lime/75 tracking-widest font-semibold">ROCKET PHASE</span>
