...
export function OverviewPage() {
  return (
    <DocPageShell kicker="Rocket Booster API" title="Self-improving browser agents">
      ...
      <DocSection title="How it self-improves" delay={80}>
        <ul className="space-y-3 text-[14px] text-text-dim leading-relaxed list-none pl-0">
          ...
          <li className="flex gap-3">
            ...
            <span>
              <code className="font-mono text-[12px] text-sky/90">POST /chat</code> — if embedding match is high enough, runs Rocket (Playwright + agent); otherwise full agent and{' '}
          ...
          <li className="flex gap-3">
            ...
            <span>
              <code className="font-mono text-[12px] text-sky/90">POST /compare</code> — baseline vs rocket in parallel for benchmarking.
            </span>
          </li>
        </ul>
      </DocSection>
